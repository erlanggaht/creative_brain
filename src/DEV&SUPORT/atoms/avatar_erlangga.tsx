    ...
    return (
        <div className='card_avatar  w-72 md:w-60 snap-start opacity-100  cursor-text transition-all hover:transition-all group' data-aos='fade-in'>
            ...
            <div className='flex justify-center gap-2 my-6'>
                <button className='py-2 text-sm px-5 bg-[#171717] hover:opacity-80 rounded'>Follow</button>
                <button className='py-2 text-sm px-5 bg-[#171717] hover:opacity-80 rounded'>Message</button>
            </div>
