...
export default function Main_Dev_Suport() {
    ...
    return (
        <>
            ...
            <section className='list-x card_avatar avatar_suport flex gap-12 gap-x-8  mt-12 p-12 pt-3 px-6 md:p-2  overflow-x-auto w-full lg:overflow-visible lg:flex-wrap lg:justify-center  cursor-grab active:cursor-grabbing' id="scroll_container">
